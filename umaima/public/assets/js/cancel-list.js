...
$(function() {
    ...
    if (n.length) {
        t = n.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                ...
                },
                 {
                    targets: 4,
                    render: function(t, e, a, s) {
                        return '<span class="text-heading">' + a.bank+ "</span>";
                    }
                },
                {
                    targets: 5,
            ...
            {
                text: '<i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Cancel Plot</span>',
                className: "add-new btn btn-primary mb-6 mb-md-0 waves-effect waves-light",
                attr: {
                    onclick: "window.location.href='/setup/cancel-create'",
