...
$(function () {
    ...
    ((t = n.DataTable({
        ...
        buttons: [
            ...
            {
                text: '<i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Loan-Entry</span>',
                className: "add-new btn btn-primary mb-6 mb-md-0 waves-effect waves-light ml-2",
                attr: {
                    onclick: "window.location.href='/add-loan'",
                },
                init: function (e, a, t) {
