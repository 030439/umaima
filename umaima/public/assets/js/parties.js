    ...
    if (n.length) {
        t = n.DataTable({
            ...
            columns: [   // Map to 'name' in the returned JSON
                ...
                { data: 'id',title:"Phone" },     // Map to 'name' in the returned JSON
                { data: 'id',title:"Address" },    
                { data: 'id',title:"Total-Received" },    // Map to 'id' in the returned JSON
                { data: 'id',title:"Total-Loan" }, 
            ...
            columnDefs: [
                ...
                },
                {
                    targets: 1,
                    render: function(t, e, a, s) {
                        return '<span class="text-heading">' + a.phone + "</span>";
                    }
                ...
                },
                {
                    targets: 2,
                    render: function(t, e, a, s) {
                        return '<span class="text-heading">' + a.address + "</span>";
                    }
                },
                {
                    targets: 3,
                    render: function(t, e, a, s) {
                        return '<span class="text-heading">' + a.received + "</span>";
                    }
                },
                {
                    targets: 4,
                    ...
                    render: function(t, e, a, s) {
                        return `
                            <div class="d-flex align-items-center">
                                ...
                                <a href="/edit/party/${a.id}" class="btn btn-icon btn-text-secondary waves-effect waves-light rounded-pill">
            ...
            {
                text: '<i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add  Party</span>',
                className: "add-new btn btn-primary mb-6 mb-md-0 waves-effect waves-light",
                attr: {
                    onclick: "window.location.href='/add-party'"
                },
                init: function (e, a, t) {
