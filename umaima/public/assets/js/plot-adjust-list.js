    ...
    if (n.length) {
        t = n.DataTable({
            ...
            columns: [   // Map to 'name' in the returned JSON
                ...
                { data: 'id',title:"From_Scheme" }, 
                { data: 'id',title:"From_Allote" }, 
                { data: 'id',title:"Plot" }, 
                { data: 'id',title:"To_Scheme" }, 
                { data: 'id',title:"To_Allote" }, 
                { data: 'id',title:"Plot" }, 
            ...
            columnDefs: [
               ...
               
                {
                    ...
                    render: function(t, e, a, s) {
                        return '<span class="text-heading">' + a.tdate + "</span>";
                    }
                },
                {
                    targets: 1,
                    render: function(t, e, a, s) {
                        return '<span class="text-heading">' + a.scheme1 + "</span>";
                    }
                ...
                },
                {
                    targets: 3,
                    render: function(t, e, a, s) {
                        return '<span class="text-heading">' + a.plot1+ "</span>";
                    }
                },
                 {
                    targets: 4,
                    render: function(t, e, a, s) {
                        return '<span class="text-heading">' + a.scheme2+ "</span>";
                    }
                },
                {
                    targets: 5,
                ...
                },
                {
                    targets: 6,
                    render: function(t, e, a, s) {
                        return '<span class="text-heading">' + a.plot2 + "</span>";
                    }
                },
                 {
                    targets: 7,
            ...
            {
                text: '<i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block"> Plot Adjust</span>',
                className: "add-new btn btn-primary mb-6 mb-md-0 waves-effect waves-light",
                attr: {
                    onclick: "window.location.href='/setup/plot-adjust-create'",
