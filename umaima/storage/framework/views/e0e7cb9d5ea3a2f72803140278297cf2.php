            ...
            <div class="row">
                <div class="col-xxl-4 col-xl-12 col-lg-12">
                    ...
                    <div class="card-body">
                        ...
                        <?php if($accounts): ?>
                        <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="mb-6">
                                <div class="d-flex align-items-center">
                                <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                    <div class="me-2">
                                        <h6 class="mb-0"><?php echo e($Expense->name); ?></h6>
                                    </div>
                                </div>
                                </div>
                            </li>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\umaima\umaima\resources\views/accounts/account-head.blade.php ENDPATH**/ ?>