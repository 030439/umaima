            ...
            <div class="row">
                <div class="col-xxl-4 col-xl-6 col-lg-12">
                    ...
                    <div class="card-body">
                        ...
                        <?php if($installments->isNotEmpty()): ?>
                        <?php $__currentLoopData = $installments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $installment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="mb-6">
                                ...
                                <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                    <div class="me-2">
                                        <h6 class="mb-0"><?php echo e($installment->installment); ?></h6>
                                    </div>
                                </div>
                                </div>
                            </li>
                    ...
                    <div class="card-body">
                        ...
                        <?php $__currentLoopData = $durations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $duration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="mb-6 d-flex justify-content-between align-items-center">
                                ...
                                <h6 class="mb-0 ms-4 badge bg-label-info rounded"><?php echo e($duration->durationname); ?></h6>
                                <div class="d-flex">
                                    <p class="mb-0"><?php echo e($duration->durations); ?></p>
                                </div>
                                </div>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\umaima\umaima\resources\views/plots/installments.blade.php ENDPATH**/ ?>