      ...
      <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <div class="navbar-nav align-items-center">
          <div class="nav-item navbar-search-wrapper mb-0">
                  <i><?php echo e(__('Welcome!')); ?> / <?php echo $breadCrumb;?></i>
        ...
        <li class="nav-item dropdown-language dropdown">
            ...
            <?php $__currentLoopData = $available_locales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale_name => $available_locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <li>
                <a class="dropdown-item waves-effect <?php if($available_locale === $current_locale){echo 'active';}?>" href="language/<?php echo e($available_locale); ?>">
...
</nav><?php /**PATH C:\xampp\htdocs\umaima\umaima\resources\views/partials/nav.blade.php ENDPATH**/ ?>