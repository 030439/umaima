    ...
    <form id="schemePlotForm" class="row g-6"  onsubmit="return false">
        ...
        <div class="col-6">
            ...
            <select class="form-select" id="" name="schemeSelection" disabled >
                ...
                <option <?php if($plots->scheme_id==$scheme->id){echo "Selected";} ?>><?php echo e($scheme->name); ?></option>
        ...
        <div class="col-md-6">
            ...
            <input type="text" id="plotNumber" class="form-control" value="<?php echo e($plots->plot_number); ?>" tag="Plot number" name="plotNumber"  />
            <div class="invalid-feedback">Please enter the plot number.</div>
        </div>
        <input type="hidden" id="pid" value="<?php echo e($plots->id); ?>">
        ...
        <div class="col-6">
            ...
            <?php if($sizes): ?>
                ...
                <option value="<?php echo e($size->id); ?>" <?php if($plots->plot_size_id==$size->id){echo "Selected";} ?>><?php echo e($size->size); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
            </select>
        </div>
        <div class="col-6">
            ...
            <select class="form-select" id="plotCategories" name="plotCategories" >
                 <?php if($plot_categories): ?>
                <?php $__currentLoopData = $plot_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($ps->id); ?>" <?php if($plots->plot_category_id ==$ps->id){echo "Selected";} ?>><?php echo e($ps->category_name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
        ...
        <div class="col-6">
            ...
            <?php if($categories): ?>
                ...
                <option value="<?php echo e($cat->id); ?>" <?php if($plots->category_id==$cat->id){echo "Selected";} ?>><?php echo e($cat->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
            </select>
            <div class="valid-feedback">Looks good!</div>
        ...
        <div class="col-6">
            ...
            <?php if($locations): ?>
                ...
                <option value="<?php echo e($location->id); ?>" <?php if($plots->plot_location_id ==$location->id){echo "Selected";} ?>><?php echo e($location->location_name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
            </select>
            <div class="valid-feedback">Looks good!</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\umaima\umaima\resources\views/schemes/edit-plots.blade.php ENDPATH**/ ?>