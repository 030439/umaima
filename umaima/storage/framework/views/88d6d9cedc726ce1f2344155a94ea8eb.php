...
<script>
 function submitdata(event) {
    ...
    setTimeout(function () {
        ...
        fetch("<?php echo e(route('allote.create')); ?>", {
            method: "POST",
            body: formData,
            headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\umaima\umaima\resources\views/allote/add.blade.php ENDPATH**/ ?>