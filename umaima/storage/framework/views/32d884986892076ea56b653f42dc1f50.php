...
<?php $__env->startSection('title', 'edit-scheme'); ?>
...
<form id="schemeForm" class="row g-6" onsubmit="return false">
  <div class="col-md-6">
    ...
    <input type="text" id="schemeName" class="form-control" value="<?php echo e($scheme->name); ?>" tag="Scheme name" name="schemeName" />
    <div class="invalid-feedback"></div>
  </div>
  
  <div class="col-md-6">
    <label class="form-label" for="schemeArea">Area</label>
    <input class="form-control" type="number" id="schemeArea" value="<?php echo e($scheme->area); ?>" name="schemeArea" tag="Scheme area" />
  </div>

  <div class="col-md-6">
    <label class="form-label" for="numberOfPlots">No. of Plots</label>
    <input class="form-control" type="number" id="numberOfPlots" value="<?php echo e($scheme->no_of_plots); ?>" name="numberOfPlots" tag="Number of plots" />
  </div>

  <div class="col-md-6">
    <label class="form-label" for="totalValuation">Total Valuation</label>
    <input class="form-control" type="number" id="totalValuation" value="<?php echo e($scheme->total_valuation); ?>" name="totalValuation" tag="Total valuation" />
  </div>
  <input type="hidden" id="editId" value="<?php echo e($scheme->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\umaima\umaima\resources\views/schemes/edit.blade.php ENDPATH**/ ?>