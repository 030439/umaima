                  ...
                  <div class="modal-content" data-select2-id="89">
                    <div class="modal-body" data-select2-id="88">
                      ...
                      <div class="text-center ">
                        <h4 class="mb-2">Enter Scheme  Information</h4>
                      </div>
                      <form id="editUserForm" class="row g-6 fv-plugins-bootstrap5 fv-plugins-framework" novalidate>
                        <div class="col-12 col-md-6">
                          <label class="form-label" for="modalEditUserFirstName">Scheme Name</label>
                        ...
                        <div class="col-12 col-md-6">
                          <label class="form-label" for="modalEditUserLastName">Scheme Area</label>
                        ...
                        <div class="col-12 col-md-6">
                          <label class="form-label" for="modalEditUserName">No of Plots</label>
                        ...
                        <div class="col-12 col-md-6">
                          <label class="form-label" for="modalEditUserEmail">Total Valuation</label>
