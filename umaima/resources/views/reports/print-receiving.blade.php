...
<html>
  ...
  <div class="sub-header">
    ...
    @foreach ($reports as $report) 
        <div class="category-title">Voucher Type: CRV &nbsp;&nbsp;&nbsp;&nbsp; Block {{$report['category_name']}}</div>
        <table>
            <thead>
            <tr>
                <th>Date</th>
            ...
            <tr class="total-row">
                <td colspan="5">TOTAL &gt;&gt;&gt;&nbsp;&nbsp;&nbsp;&nbsp; Block {{$report['category_name']}}</td>
                <td>{{$report['total']}}</td>
            </tr>
    ...
    @endforeach
      ...
      <p class="category-title" style="text-align:right">OVERALL TOTAL&nbsp;&nbsp;:&nbsp;&nbsp; {{$total}}</p>
