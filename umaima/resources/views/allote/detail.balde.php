@extends('layout.app')
<?php $breadCrumb='Allote / <span class="text-primary">Detail</span></i>'?>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="col-xl-8 col-lg-7 order-0 order-md-1">
            ...
            <ul class="nav nav-pills flex-column flex-md-row flex-wrap mb-6 row-gap-2">
                ...
                <li class="nav-item"><a class="nav-link" href="app-user-view-security.html"><i class="ti ti-lock ti-sm me-1_5"></i>Security</a></li>
                <li class="nav-item"><a class="nav-link" href="app-user-view-billing.html"><i class="ti ti-bookmark ti-sm me-1_5"></i>Billing & Plans</a></li>
                <li class="nav-item"><a class="nav-link" href="app-user-view-notifications.html"><i class="ti ti-bell ti-sm me-1_5"></i>Notifications</a></li>
                <li class="nav-item"><a class="nav-link" href="app-user-view-connections.html"><i class="ti ti-link ti-sm me-1_5"></i>Connections</a></li>
            </ul>
            </div>
            <!--/ User Pills -->
