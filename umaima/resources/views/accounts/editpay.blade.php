                ...
                <form class="card-body" id="pay-form" onsubmit="return false">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" id="paydate" value="{{$payment->pdate}}" name="paydate" class="form-control dob-picker" placeholder="YYYY-MM-DD" />
                        </div>
                        ...
                        <div class="col-6 <?= $payment->payment_type==1?'':'d-none'?>" id="allote_section">
                            ...
                            <select id="allotees" name="allotees" class="select2 form-select" data-allow-clear="true">
                                ...
                                <?php if($payment->payment_type==1){?>
                                    <option selected value="{{$payment->allote_id}}">{{$payment->allote}}</option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="col-6 <?= $payment->payment_type==1?'':'d-none'?>" id="plot_section">
                            ...
                            <select id="plot" name="plot" class="select2 form-select" data-allow-clear="true">
                                ...
                                <?php if(!empty($plot)){?>
                                 <option selected value="{{$plot['plot']}}">{{$plot['plot_number']}}</option>
                                 <?php }?>
                            </select>
                        </div>
                            ...
                            <select id="expense_heads" name="expense_heads" class="select2 form-select" data-allow-clear="true">
                                <option value="">Select Expense Head</option>
                                 <?php if($payment->payment_type==2){?>
                                    <option selected value="{{$payment->expense}}">{{$payment->expense_name}}</option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <select id="from_account" name="from_account" class="select2 form-select" data-allow-clear="true">
                                ...
                                <option <?= $payment->bank_id==$account->id?"selected":""?> value="{{$account->id}}">{{$account->bank_name}}</option>
                                <?php }?>
                        ...
                        <div class="col-6">
                            ...
                            <input type="number" id="amount" value="{{$payment->amount}}" name="amount" class="form-control" tag="Enter Amount" />
                        </div>

                        <div class="col-6">
                            <label class="col-form-label text-sm-end" for="narration">Receipt No</label>
                            <input type="text" id="receipt_id" value="{{$payment->receipt_id}}" name="receipt_id" class="form-control" tag="Enter Narration" />
                        </div>

                        <div class="col-6">
                            <label class="col-form-label text-sm-end" for="narration">Narration</label>
                            <input type="text" id="narration"  value="{{$payment->narration}}" name="narration" class="form-control" tag="Enter Narration" />
                        </div>
                    </div>
