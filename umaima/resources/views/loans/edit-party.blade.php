@extends('layout.app')
<?php $breadCrumb=' Loan-Party / <span class="text-primary">Edit</span></i>'?>
@section('title', 'Loan-party-edit')
@section('content')
...
<div class="col-12">
<div class="card">
<h5 class="card-header">Edit Loan Party</h5>
<div class="card-body">
    <form id="schemePlotForm" class="row g-6"  onsubmit="return false">
        <div class="col-6">
        <label class="form-label" for="plotNumber">Name</label>
            <input type="text" id="name" class="form-control" value="{{$party->name}}" tag="name" name="name"  />
            <div class="invalid-feedback">Please enter Name.</div>
        </div>

        <div class="col-md-6">
            <label class="form-label" for="plotNumber">Phone Number</label>
            <input type="text" id="phone" class="form-control" value="{{$party->phone}}"  tag="phone" name="phone"  />
            <div class="invalid-feedback">Please enter the Phone number.</div>
        </div>

        <div class="col-6">
            <label class="form-label" for="plotNumber">Address</label>
            <input type="text" id="address" class="form-control" value="{{$party->address}}" tag="address" name="address"  />
